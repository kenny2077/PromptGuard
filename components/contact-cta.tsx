      ...
      <div className="mx-auto max-w-7xl px-5 py-14 text-center sm:px-8 lg:px-10">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <button
            ...
            className="inline-flex h-12 min-w-40 items-center justify-center rounded-lg bg-[#080810] px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#080810]"
          >
            Book a demo
          </button>
          <a
            href="mailto:sales@promptguard.ai"
            className="inline-flex h-12 min-w-40 items-center justify-center gap-2 rounded-lg border border-black/12 bg-white px-6 text-sm font-semibold text-[#080810] shadow-sm transition hover:border-black/20 hover:bg-[#fbfbfa]"
          >
            Contact sales
      ...
      {open ? (
        ...
        >
          <div
            ...
            className="max-h-[calc(100vh-4rem)] w-full max-w-2xl overflow-y-auto rounded-lg border border-black/10 bg-white text-[#090912] shadow-2xl"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 px-6 py-6 sm:px-8">
                <label className="block">
                  ...
                  <input
                    ...
                    className="mt-2 h-12 w-full rounded-lg border border-black/15 bg-white px-4 text-base text-[#090912] outline-none transition placeholder:text-[#9b9ca6] focus:border-[#080810] focus:ring-4 focus:ring-black/5"
                  />
                </label>
                ...
                <label className="block">
                  ...
                  <select
                    ...
                    name="role"
                    defaultValue=""
                    className="mt-2 h-12 w-full rounded-lg border border-black/15 bg-white px-4 text-base text-[#090912] outline-none transition focus:border-[#080810] focus:ring-4 focus:ring-black/5"
                  >
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    className="mt-2 min-h-28 w-full resize-none rounded-lg border border-black/15 bg-white px-4 py-3 text-base leading-7 text-[#090912] outline-none transition placeholder:text-[#9b9ca6] focus:border-[#080810] focus:ring-4 focus:ring-black/5"
                  />
                </label>

                <button
                  type="submit"
                  className="inline-flex h-12 w-full items-center justify-center rounded-lg bg-[#080810] px-6 text-base font-semibold text-white transition hover:bg-black"
                >
                  Submit request
                </button>
